...
type luaStack struct {
	...
	top   int
	/* call info */
	//in order to access the registry table of the luaState, we keep a luaState pointer.
	//Access the registry table by fake index.
	state   *luaState
	closure *closure
	varargs []luaValue
...
/*
	There are three kinds of values: upvalue, registry, local varaible.
	The luaStack operate these values by different way.
*/
