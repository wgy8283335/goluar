...
/*
	@description
		Check the type of the closure pointed by idx. If c.goFunc is not nil, means the closure is go closure.
*/
...
/*
	@description
		Get a go closure from stack by idx, and return the function of the closure.
*/
